...
async function main() {
  ...
  const task1_1 = await prisma.task.create({
    data: {
      ...
      actualEndDate: new Date('2026-02-01'),
      estimatedHours: 24,
      actualHours: 20,
      progress: 100,
      projectId: project1.id,
  ...
  const task1_2 = await prisma.task.create({
    data: {
      ...
      dueDate: new Date('2026-02-08'),
      actualStartDate: new Date('2026-01-30'),
      actualEndDate: new Date('2026-02-07'),
      estimatedHours: 16,
      actualHours: 18,
      progress: 100,
      projectId: project1.id,
  ...
  const task1_2b = await prisma.task.create({
    data: {
      ...
      actualStartDate: new Date('2026-02-02'),
      actualEndDate: new Date('2026-02-09'),
      estimatedHours: 20,
      actualHours: 22,
      progress: 100,
      projectId: project1.id,
  ...
  const task1_2c = await prisma.task.create({
    data: {
      ...
      actualEndDate: new Date('2026-01-27'),
      estimatedHours: 16,
      actualHours: 14,
      progress: 100,
      projectId: project1.id,
  ...
  const task1_2d = await prisma.task.create({
    data: {
      ...
      actualEndDate: new Date('2026-02-02'),
      estimatedHours: 20,
      actualHours: 18,
      progress: 100,
      projectId: project1.id,
  ...
  const task1_3 = await prisma.task.create({
    data: {
      ...
      actualStartDate: new Date('2026-02-05'),
      estimatedHours: 32,
      actualHours: 20,
      progress: 65,
      projectId: project1.id,
  ...
  const task1_4 = await prisma.task.create({
    data: {
      ...
      actualStartDate: new Date('2026-02-08'),
      estimatedHours: 24,
      actualHours: 12,
      progress: 50,
      projectId: project1.id,
  ...
  const task1_4b = await prisma.task.create({
    data: {
      ...
      actualStartDate: new Date('2026-02-10'),
      estimatedHours: 16,
      actualHours: 6,
      progress: 35,
      projectId: project1.id,
  ...
  const task1_4c = await prisma.task.create({
    data: {
      ...
      dueDate: new Date('2026-02-18'),
      actualStartDate: new Date('2026-02-07'),
      estimatedHours: 24,
      actualHours: 10,
      progress: 40,
      projectId: project1.id,
  ...
  const task1_4d = await prisma.task.create({
    data: {
      ...
      actualStartDate: new Date('2026-02-11'),
      estimatedHours: 12,
      actualHours: 4,
      progress: 25,
      projectId: project1.id,
  ...
  await prisma.task.create({
    data: {
      ...
      actualStartDate: new Date('2026-01-28'),
      actualEndDate: new Date('2026-02-03'),
      estimatedHours: 16,
      actualHours: 14,
      progress: 100,
      projectId: project2.id,
  ...
  await prisma.task.create({
    data: {
      ...
      actualStartDate: new Date('2026-01-30'),
      actualEndDate: new Date('2026-02-05'),
      estimatedHours: 12,
      actualHours: 10,
      progress: 100,
      projectId: project2.id,
